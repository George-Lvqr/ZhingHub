...
if "%copyConfirm%"=="y" (
    rem 复制模组文件夹
    xcopy /e /y "G:\Minecraft\模组" "%userprofile%\Desktop\模组" || set error_occurred=true
    rem 复制皮肤文件夹
    xcopy /e /y "G:\Minecraft\皮肤" "%userprofile%\Desktop\皮肤" || set error_occurred=true
)
...
xcopy /s /e /h /y "G:\Minecraft\PCL" "D:\PCL II\PCL" || set error_occurred=true

rem 9.复制游戏文件
set "src_folder=G:\Minecraft\.minecraft"
